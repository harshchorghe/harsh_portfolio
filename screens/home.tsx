    ...
    <section id="home" className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-black">
      <div className="max-w-screen-xl mx-auto px-8 py-24 text-center">
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <a
            className="inline-block rounded-full border border-zinc-200 px-6 py-3 text-zinc-900 dark:text-zinc-50 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition"
            href="#contact"
          >
            Contact
          </a>
