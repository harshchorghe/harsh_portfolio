...
export const Home = ({ size = 20, className = "" }: IconProps) => (
  ...
  >
    <path d="M3 9.5L12 3l9 6.5V21a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1V9.5z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
export const Briefcase = ({ size = 20, className = "" }: IconProps) => (
  ...
  >
    ...
    <path d="M9 7V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
export const Youtube = ({ size = 20, className = "" }: IconProps) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M22.54 6.42a2.6 2.6 0 0 0-1.83-1.84C18.88 4 12 4 12 4s-6.88 0-8.71.58A2.6 2.6 0 0 0 1.46 6.42 27.72 27.72 0 0 0 0 12a27.72 27.72 0 0 0 1.46 5.58 2.6 2.6 0 0 0 1.83 1.84C5.12 20 12 20 12 20s6.88 0 8.71-.58a2.6 2.6 0 0 0 1.83-1.84A27.72 27.72 0 0 0 24 12a27.72 27.72 0 0 0-1.46-5.58z" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
